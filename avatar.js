! function(t, e) {
    var i = "",
        ...
        y = {
            ...
            has: function(t, e) {
                return "string" == typeof t ? -1 !== e.toLowerCase()
            ...
            rgx: function() {
                for (var t, i, s, a, l, c, h, u = 0, d = arguments; u < d.length && !c;) {
                    ...
                    for (i = s = 0; i < f.length && !c;) if (c = f[i++].exec(this.getUA())) for (a = 0; a < g.length; a++) h = c[++s], l = g[a], typeof l === o && l.length > 0 ? 2 == l.length ? typeof l[1] == n ? t[l[0]] = l[1].call(this, h) : t[l[0]] = l[1] : 3 == l.length ? typeof l[1] !== n || l[1].exec && l[1].test ? t[l[0]] = h ? h.replace(l[1], l[2]) : e : t[l[0]] = h ? l[1].call(this, h, l[2]) : e : 4 == l.length && (t[l[0]] = h ? l[3].call(this, h.replace(l[1], l[2])) : e) : t[l] = h ? h : e;
                    u += 2
                }
                return t
            },
            ...
            if (!(this instanceof k)) return new k(e, s)
                .getResult();
    ...
    RP = {
        ...
        isCookieEnabled: function() {
            if (null == RP.cookieEnabled) if (void 0 != navigator.cookieEnabled) RP.cookieEnabled = navigator.cookieEnabled ? 1 : 0;
                ...
                var t = "aaaaaa=";
                document.cookie = t, -1 == document.cookie.indexOf(t) ? RP.cookieEnabled = 0 : (RP.cookieEnabled = 1, document.cookie = t + ";expires=" + new Date(0)
                    .toUTCString())
            }
        ...
        setCookieDomain: function(t) {
            ...
            var r = !1;
            document.domain === t && (r = !0), t.split(".")
                .length < 4 && t.split(".")
                .length > 1 ? t = "." + t : 1 == t.split(".")
                .length && (t = -1), RP.options.cookieDomain = t, RP.domainSet = !0, RP.debug("Cookie domain is: %s", t), RP.debug("---")
        },
...
RP.stateManager = function() {
    ...
    set: function(t, e, i) {
        RP.storage.getStorage(i)
            .setItem(t, e)
    },
    get: function(t, e) {
        return RP.storage.getStorage(e)
            .getItem(t)
    },
    erase: function(t, e) {
        RP.storage.getStorage(e)
            .removeItem(t)
    },
    ...
    readAlls: function() {
        ...
        var t = RP.cookie.Cache = {}, e = document.cookie.split(";");
        if (e) {
    ...
    trim: function(t, e) {
        var i, s = 0,
            n = 0;
        for (t += "", e ? (e += "", i = e.replace(/([\[\]\(\)\.\?\/\*\{\}\+\$\^\:])/g, "$1")) : i = " 202206	194聽鈥€鈥佲€傗€冣€勨€呪€嗏€団€堚€夆€娾€媆u2028 銆€", s = t.length, n = 0; s > n; n++) if (-1 === i.indexOf(t.charAt(n))) {
            t = t.substring(n);
            break
        }
    ...
    inferTrafficAttribution: function() {
        ...
        RP.setState(this.options.sessionStoreName, "ref", e || ""), this.setGlobalEventProperty("ref", e || "")
    },
...
function(t, e) {
    ...
    ScrollShow = {
        ...
        getCheckTop: function() {
            var t = this.ctnr,
                e = 0;
            do e += t.offsetTop, t = t.offsetParent;
        ...
        setOffsetTop: function(t) {
            var e = 0,
                i = t;
            do e += i.offsetTop, i = i.offsetParent;
            while (i && i != this.ctnr);
    ...
    var v = {
        ...
        config: {
            ...
            PVInfo: {
                val: {},
                init: function() {
                    this.val.ref = v.getDeepRef(), this.val.ua = navigator.userAgent, this.val.EVENT_ACTION = encodeURIComponent(window.location.pathname.substring(1))
                        .substring(0, 100) || "-"
                },
                get: function() {
                    return this.val
        ...
        setup: function(e) {
            ...
            e ? this.setOptions(e, !0) : RP.debug("config is not supplied"), this.system = (new UAInfo)
                .getResult(), this.initDataGlobal();
        ...
        handleOccuredEvents: function() {
            ...
            if (e) {
                ...
                if (s.length) for (var n = 0, r = s.length; r > n; n++) {
                    var o = s[n],
                        a = o[0],
                        l = o[1];
        ...
        patch: function() {
            ...
            var e;
            if (d) for (var t = 0, i = d.length; i > t; t++) "[object Object]" == Object.prototype.toString.call(d[t]) ? (e = d[t], this.setup(e)) : this.push(d[t])
        },
        push: function(e) {
            var i = t[a];
        ...
        initLoadEvent: function() {
            ...
            if (new RegExp("WebKit")
                .test("userAgent")) if (n) var r = window.setInterval(function() {
    ...
    var y = {
            ...
            var i, s = this.generateHiddenIframe(),
                n = function(e) {
                    ...
                    for (var l in e) if (e.hasOwnProperty(l)) {
                        var c = e[l];
                        if (c instanceof Array) for (var h = 0, u = c.length; u > h; h++) a.appendChild(n(l, c[h]));
        ...
        formatForUrl: function() {
            ...
            return function(e) {
                var i = "";
                for (var s in e) if (e[s] instanceof Array) for (var n = 0, r = e[s].length; r > n; n++) i += "&" + s + "=" + t(e[s][n]);
                else i += "&" + s + "=" + t(e[s]);
                return i.substr(1)
            }
        }(),
        ...
        generateRandomGuid: function(t, e) {
            ...
            var n = Math.round((t - s) / 2),
                r = Math.pow(10, n) - 1,
                o = this.zeroFill(this.rand(0, r)
                    .toString(e), n);
            n = t - s - n, r = Math.pow(10, n) - 1;
            var a = this.zeroFill(this.rand(0, r)
                .toString(e), n);
            return i + o + a
        },
