...
if (backurl) {
    ...
    document.getElementsByTagName("bg")[0].style = "background-image: url(https://dl3.img.timecdn.cn/2021/12/30/field_forest.jpg);"
}
...
function savebackimg() {
    ...
    localStorage.setItem("backurl", document.getElementById("backimg")
        .value)
    alert("保存成功！")
...
function savebackimg64() {
    document.getElementById("settingpage")
        .style = "display:block;opacity:0"
    setTimeout(function() {
        document.getElementById("settingpage64")
            .style = "display:none"
    }, 200)
    localStorage.setItem("backurl", document.getElementById("conte")
        .value)
    alert("保存成功！")
    window.location.reload()
}
...
function localbg() {
    document.getElementById("settingpage2")
        .style = "display:block;opacity:0"
    setTimeout(function() {
        document.getElementById("settingpage2")
            .style = "display:block;opacity:1"
